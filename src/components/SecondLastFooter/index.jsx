...
import './SecLastFooter.css'

const SecondLastFooter = () => {
  return (
    <div>
      <div className='sec_last_footer_div'>
        <ul className='sec_last_footer_ol'>
          <li className='sec_last_footer_li'>
            <div className='sec_last_footer_para_div'>
              <p className='sec_last_footer_p'>
